                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-100">
                                    <h2 class="font-weight-bolder mb-0">Mükellef</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-sm-5">
                        <div class="card  mb-2">
                            <div class="card-header p-3 pt-2">
                                ...
                                <div class="text-end pt-1">
                                    <p class="text-sm mb-0 text-capitalize">Şirket</p>
                        ...
                        <div class="card  mb-2">
                            <div class="card-header p-3 pt-2">
                                ...
                                <div class="text-end pt-1">
                                    <p class="text-sm mb-0 text-capitalize">Basit Usul</p>
                    ...
                    <div class="col-lg-5 col-sm-5 mt-sm-0 mt-4">
                        <div class="card  mb-2">
                            <div class="card-header p-3 pt-2 bg-transparent">
                                ...
                                <div class="text-end pt-1">
                                    <p class="text-sm mb-0 text-capitalize ">İşletme </p>
                                    <h4 class="mb-0 ">34</h4>
                                </div>
                            </div>
                        ...
                        <div class="card ">
                            <div class="card-header p-3 pt-2 bg-transparent">
                                ...
                                <div class="text-end pt-1">
                                    <p class="text-sm mb-0 text-capitalize ">Basit Usul Sayısı</p>
                                    <h4 class="mb-0 ">+91</h4>
                                </div>
                            </div>
